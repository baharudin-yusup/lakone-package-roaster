...
import 'package:roaster_repository/src/apis/base.dart';

import 'apis/ble.dart';
...
class LakoneRepository {
  ...
  final ConnectionBaseAPI<MachineAPI, BluetoothDeviceAPI> _api = BleAPI();
  ...
  Future<void> startScan() async {
    ...
    if (Platform.isAndroid) {
      ...
      if (specialPermission) {
        ...
        permissionOk = location && bluetooth;
      }
    }
  ...
  Stream<LakoneBluetoothState> get onBluetoothStateChanged {
    return _api.onBluetoothStateChanged;
  }
